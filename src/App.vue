<template>
  <v-app>
    <div class="d-flex">
      <router-link to="/color" class="ma-2">color</router-link>
      <router-link to="/content" class="ma-2">content</router-link>
      ...
      <router-link to="/selectbox" class="ma-2">selectbox</router-link>
    </div>
